...
class FlightSearch:
    ...
    def __init__(self):
        ...
        print(f"API secret: {self._api_secret}")
    ...
    def check_flights(self, origin_city_code, destination_city_code, from_time, to_time, nonstop=True):
        """
        ...
        Parameters:
            ...
            is_direct (bool): Whether to search for direct flights only. Default is True.
...
# Write a test case to check if the FlightSearch class is working correctly
...
#     # print(flight_search.get_destination_code("London"))
#     response = flight_search.check_flights("LON", "NYC", tomorrow, six_month_from_today)
#     with open("output_nonstop_true.json", "w") as file:
